<div class="row">
   ...
   <?php endif; ?>
    ...
    <div id="right" class="sl-rsp-modal sidebar-modal col-md-3">
     ...
     <?php endif; ?>
    <div id="center" class="<?php if( !$this->isEmpty('east') &&  !$this->isEmpty('west') ): echo 'col-md-6'; elseif (($this->isEmpty('east') && !$this->isEmpty('west')) || ($this->isEmpty('west') && !$this->isEmpty('east'))): echo 'col-md-9'; else: echo 'col-md-12'; endif; ?>">
        <?php echo $center; ?>
    </div>
