    ...
    <div class="feed-entry-warp">
                    ...
                    <div class="activity_content_head">
                        ...
                        <div class="activity_option">
                            <div class="feed-option">
                                ...
                                <?php // delete link available for activity poster, site admin and item admins
                    ...
                    <div class="feed_time">
                        ...
                        <?php if (!$activity['Activity']['target_id']):?>
                            ...
                            <span class="feed_time-txt">
                                <div class="dropdown">
                                    <a id="permission_<?php echo $activity['Activity']['id'] ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" class="tip" href="javascript:void(0);" original-title="<?php echo $text;?>">
                                        <span class="feed_time-icon material-icons moo-icon moo-icon-<?php echo $icon;?>"><?php echo $icon;?></span>
        ...
        <div class="feed_comment_info">
            ...
            <?php if( (isset($groupTypeItem) && $groupTypeItem['is_member']) || (!isset($groupTypeItem)) ) : ?>
                ...
                <div class="comment_holder comment_recent activity_comments" id="comments_<?php echo $activity['Activity']['id']?>" <?php if (empty($activity['ActivityComment']) && empty($activity['PhotoComment']) && empty($activity['Activity']['like_count']) && empty($activity['ItemComment']) && ( $activity['Activity']['params'] != 'item' || empty($object[$name]['like_count']) ) && (!$is_close_comment || (isset($is_member) && !$is_member && !empty($cuser) && !$cuser['Role']['is_admin']) || empty($uid))) {echo 'style="display:none"';$showFormComment = false;} ?>>
                                ...
                                <div id="newComment_<?php echo $activity['Activity']['id']?>" class="comment-form-warp">
                                    <div class="comment-form">
                                        <div class="comment-form-left">
                                            <?php echo $this->Moo->getItemPhoto(array('User' => $cuser), array( 'prefix' => '50_square','tooltip' => true), array('class' => 'user_avatar'))?>
                                        </div>
                                                ...
                                                <div class="comment-form-area">
                                                    <div class="post-area">
                                                        <div class="post-area-text">
                                                            <?php echo $this->Form->textarea("commentForm_".$activity['Activity']['id'],array('class' => "post-area-input commentBox commentBox showCommentBtn", 'data-id' => $activity['Activity']['id'], 'placeholder' => __('Write a comment...') ), true) ?>
                                                        </div>
                                                ...
                                                <div class="comment-form-main">
                                                    <div class="comment-form-area">
                                                        ...
                                                        <?php if($this->request->is('ajax')): ?>
                                                            <script>
                                                                require(["jquery","mooToggleEmoji"], function($, mooToggleEmoji) {
                                                                    mooToggleEmoji.init('commentReplyForm<?php echo $comment['Comment']['id'];?>', '<span class="post-area-icon material-icons">mood</span>');
                                                                });
                                                            </script>
                                                        <?php else: ?>
                                                            <?php $this->Html->scriptStart(array('inline' => false, 'domReady' => true, 'requires' => array('jquery', 'mooToggleEmoji'),  'object' => array('$', 'mooToggleEmoji'))); ?>
                                ...
                                <div class="comment-outer">
                                    <div class="comment-avatar">
                                        ...
                                        <?php if(!empty($comment_reply_creator->result['image'])):?>
                                            <?php echo $comment_reply_creator->result['image'];?>
                                        <?php else:?>
                                            <?php echo $this->Moo->getItemPhoto(array('User' => $comment['User']),array('class' => 'user_avatar_small', 'prefix' => '50_square','tooltip' => true, 'class' => 'user_avatar_link'), array('class' => 'user_avatar'))?>
                                        <?php endif;?>
                                    </div>
                                    <div class="comment-inner">
                                        <div class="comment-user-name">
                                ...
                                <div class="comment-outer">
                                    <div class="comment-avatar">
                                        ...
                                        <?php if(!empty($comment_reply_creator->result['image'])):?>
                                            <?php echo $comment_reply_creator->result['image'];?>
                                        <?php else:?>
                                            <?php echo $this->Moo->getItemPhoto(array('User' => $comment['User']),array('class' => 'user_avatar_link', 'prefix' => '50_square','tooltip' => true), array('class' => 'user_avatar'))?>
                                        <?php endif;?>
                                    </div>
                                    <div class="comment-inner">
                                        <div class="comment-user-name">
                                                ...
                                                <div class="comment-form-main">
                                                    <div class="comment-form-area">
                                                        ...
                                                        <?php if($this->request->is('ajax')): ?>
                                                            <script>
                                                                require(["jquery","mooToggleEmoji"], function($, mooToggleEmoji) {
                                                                    mooToggleEmoji.init('activitycommentReplyForm<?php echo $comment['id'];?>', '<span class="post-area-icon material-icons">mood</span>');
                                                                });
                                                            </script>
                                                        <?php else: ?>
                                                            <?php $this->Html->scriptStart(array('inline' => false, 'domReady' => true, 'requires' => array('jquery', 'mooToggleEmoji'),  'object' => array('$', 'mooToggleEmoji'))); ?>
