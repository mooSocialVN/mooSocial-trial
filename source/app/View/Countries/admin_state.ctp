...
$('.check_enable').each(function(){
    $(this).change(function(){
        ...
        jQuery.post("<?php echo $this->request->base ?>/admin/countries/save_enable/State/"+$(this).data('id') + '/' + enable,{},function(data){
...
<div class="portlet-body">
    ...
    <?php  if(!empty($states)) : ?>
    <form method="post" action="<?php echo  $this->request->base ?>/admin/countries/manage/State" id="actionForm">
            ...
            <tbody>
                ...
                foreach ($states as $state):
                    ...
                    <tr class="gradeX <?php ( ++$count % 2 ? "odd" : "even") ?>" id="<?php echo $state['State']['id'] ?>">
                        <td><input type="checkbox" name="ids[]" value="<?php echo  $state['State']['id'] ?>" class="check">
                        </td> 
                        <td>
                            ...
                            ?>
                                    ...
                                    <li>
                                        <?php $this->MooPopup->tag(array(
                                                                        ...
                                                                        'title' => __('Add City'),
                                                                        'innerHtml' => __('Add City'),
                                                                        'target' => 'ajax'
                                                                    ));?>

                                    </li>
                                    <li>
                                        <a href="<?php echo $this->Html->url(array("controller" => "countries","action" => "admin_city","plugin" => false,$state['State']['id'])) ?>"><?php echo __("Manage City") ?></a>
                                    </li>
                                    <li>
                                        <?php
                                            $this->MooPopup->tag(array(
                        ...
                        <td width="50px" class="reorder">
                            <input type="checkbox" class="check_enable" <?php if ($state['State']['enable']): ?>checked<?php endif; ?> data-id="<?php echo $state['State']['id'];?>"/>
                        </td>
