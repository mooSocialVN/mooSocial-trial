<script>
    $(document).ready(function() {
        ...
        $('#tCreateButton').click(function() {
            ...
            $.post("<?php echo  $this->request->base ?>/admin/countries/translate_save/<?php echo $model; ?>", $("#tCreateForm").serialize(), function(data) {
...
<div class="modal-body">
    <form id="tCreateForm" class="form-horizontal" role="form">
        <?php echo $this->Form->hidden('id', array('value' => $item[$model]['id'])); ?>
