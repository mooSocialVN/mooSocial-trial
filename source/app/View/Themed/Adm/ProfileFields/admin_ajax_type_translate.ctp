<script>
    $(document).ready(function() {
        ...
        $('#tCreateButton').click(function() {
            ...
            $.post("<?php echo  $this->request->base ?>/admin/profile_fields/ajax_type_translate_save", $("#tCreateForm").serialize(), function(data) {
...
<div class="modal-body">
    <form id="tCreateForm" class="form-horizontal" role="form">
        <?php echo $this->Form->hidden('id', array('value' => $profile['ProfileType']['id'])); ?>
        <?php foreach ($languages as $key => $language) : ?>
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <?php foreach ($profile['nameTranslation'] as $translation) : ?>
