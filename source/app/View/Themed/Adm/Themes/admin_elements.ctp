...
$this->Html->addCrumb(__('Elements'), array('controller' => 'themes', 'action' => 'admin_elements',$theme['Theme']['id']));
...
<?php echo $this->element('admin/themenav', array("cmenu" => "elements","theme_id"=>$theme['Theme']['id'])); ?>
