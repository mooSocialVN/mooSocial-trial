...
<?php endif;?>
        ...
        <div class="check-home">
            ...
            <div class="feed_breadcrumb">
                ...
                <?php if($title_enable): ?>
                    <h1 class="feed_breadcrumb_title"><?php echo !empty($title) ? $title : __("What's New")?></h1>
                <?php endif; ?>
                <?php endif; ?>
                <?php if ( !empty( $uid ) && Configure::read('core.feed_selection') ): ?>
                <div id="feed-type" class="feed-type-list">
                    <a href="#" data-href="<?php echo $this->request->base?>/activities/ajax_browse/everyone" class="feed-type-item <?php if ( isset($activity_feed) && $activity_feed == 'everyone' ) echo "current"; ?>">
                        <span class="feed-type-txt"><?php echo __('Everyone')?></span>
                    </a>
                    <a href="#" data-href="<?php echo $this->request->base?>/activities/ajax_browse/friends" class="feed-type-item <?php if ( isset($activity_feed) && $activity_feed == 'friends' ) echo "current"; ?>">
                        <span class="feed-type-txt"><?php if (!Configure::read("core.enable_follow")) echo __('Friends & Me'); else echo __('Friends, Following & Me');?></span>
                    </a>
                </div>
                <?php endif; ?>
            </div>
