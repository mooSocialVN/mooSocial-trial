				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="note note-success">
							<h4 class="block"><?php echo __('Please confirm'); ?></h4>
							<p><?php echo __('Are you sure you want to enable this service?'); ?></p>
						</div>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="portlet_tab1">
								<form class="form-horizontal intergration-setting" method="post"  action="<?php echo Router::url(array(
									...
									'action' => 'admin_confirm_enable_step4_ok'))?>">
									...
									<div class="form-actions">
										<div class="row">
												...
												<div class="col-md-offset-11 col-md-12">
													<input type="submit" class="btn btn-circle btn-action " value="<?php echo __('OK'); ?>">
												</div>
