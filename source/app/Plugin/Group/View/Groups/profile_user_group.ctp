    ...
    <div class="box2 bar-content-warp">
        <div class="box_header mo_breadcrumb">
            <div class="box_header_main">
                <h1 class="box_header_title text-ellipsis"><?php echo __('Groups')?></h1>
                <div class="box_action">
                    <?php if ($user_id == $uid): ?>
                    <a class="box-btn btn-header_icon box-add" href="<?php echo $this->request->base ?>/groups/create" title="<?php echo __( 'Create New Group')?>">
