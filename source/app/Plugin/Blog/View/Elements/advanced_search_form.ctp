<div id="form_main_search_wrap" class="box_header_search">
    ...
    <form id="form_main_search" class="header-advanced-search" search-type="ajax" method="get">
        <div class="header_search_holder">
            <?php echo $this->Form->text( 'keyword', array( 'placeholder' => __('Enter keyword to search'), 'rel' => 'blogs', 'class' => 'form-control advanced-search-keyword json-view') );?>
...
<script type="text/javascript">require(["jquery","mooSearchItem"], function($,mooUser) {
<?php else: ?>
