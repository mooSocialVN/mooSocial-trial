                ...
                <div class="horizontal-menu-warp">
                    <ul class="browse-menu core-horizontal-menu horizontal-menu">
                        <li id="browse_all" class="<?php if(empty($cat_id)): ?>current<?php endif; ?>">
                            <a class="horizontal-menu-link core-menu-ajax" header-title="<?php echo __( 'All Topics')?>" data-url="<?php echo $this->request->base ?>/topics/browse/all" href="<?php echo $this->request->base ?>/topics">
                                <span class="horizontal-menu-text"><?php echo __('All Topics') ?></span>
                            </a>
                        </li>
                        <?php //if (!empty($uid)): ?>
                        <li id="my_topics">
                            <a class="horizontal-menu-link core-menu-ajax" header-title="<?php echo __( 'My Topics')?>" data-url="<?php echo $this->request->base ?>/topics/browse/my" href="<?php echo $this->request->base ?>/topics">
                                <span class="horizontal-menu-text"><?php echo __('My Topics') ?></span>
                            </a>
                        </li>
                        <li id="friend_topics">
                            <a class="horizontal-menu-link core-menu-ajax" header-title="<?php echo __( "Friends' Topics")?>" data-url="<?php echo $this->request->base ?>/topics/browse/friends" href="<?php echo $this->request->base ?>/topics">
                                <span class="horizontal-menu-text"><?php echo __("Friends' Topics") ?></span>
                            </a>
                        </li>
                        <?php //endif; ?>
