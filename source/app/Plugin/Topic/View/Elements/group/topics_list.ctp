...
if (!empty($topics) && count($topics) > 0) {
    ...
    foreach ($topics as $topic):
        ?>
        <div class="core-list-item <?php if(!empty($uid) && (($topic['Topic']['user_id'] == $uid ) ||  (!empty($cuser) && $cuser['Role']['is_admin']) || in_array($uid, $topic['Topic']['admins']) ) ): ?>core-is-owner<?php endif; ?>">
                        ...
                        <div class="like-section">
                            <div class="like-action">
                                ...
                                <div class="act-item act-item-like">
                                    <a class="act-item-symbol likeItem <?php if (!empty($uid) && !empty($like[$topic['Topic']['id']])): ?>active<?php endif; ?>" href="javascript:void(0)" data-type="Topic_Topic" data-id="<?php echo $topic['Topic']['id']?>" data-status="1">
                                ...
                                <div class="act-item act-item-dislike">
                                    <a data-type="Topic_Topic" data-id="<?php echo $topic['Topic']['id']?>" data-status="0" href="javascript:void(0)" class="act-item-symbol likeItem <?php if (!empty($uid) && isset($like[$topic['Topic']['id']]) && $like[$topic['Topic']['id']] == 0): ?>active<?php endif; ?>">
                                ...
                                <div class="act-item act-item-comment">
                                    <a class="act-item-symbol" href="<?php echo  $this->request->base ?>/topics/view/<?php echo  $topic['Topic']['id'] ?>/#comments">
                                        <span class="act-item-icon material-icons moo-icon moo-icon-comment">comment</span>
                                    </a>
                                    <a class="act-item-text" href="<?php echo  $this->request->base ?>/topics/view/<?php echo  $topic['Topic']['id'] ?>/#comments">
