    ...
    <form method="get" action="<?php echo  $this->request->base ?>/admin/menu/manage">
        <a style="float: left;margin-right:10px;" href="<?php echo  $this->request->base ?>/admin/menu/manage/ajax_create"
           ...
           data-target="#ajax" data-toggle="modal">
            <i class="fa fa-plus"></i> <?php echo  __( 'Add New') ?></a>
...
<div id="nav-menus-frame">
    <div style="display: block; float: left;  margin-bottom: 10px;"><?php echo  __('Note: after a menu is created it will auto add a widget into Available Block at')?> <a href="<?php echo  $this->request->base ?>/admin/layout"><?php echo  __('Layout Editor'); ?></a> <?php echo  __('so that you can drap and drop this widget to anywhere on Page Block Placement')?></div>
                                    ...
                                    <p class="button-controls">
                                        <span class="list-controls">
                                            <a href="javascript:void(0);" onclick="selectAll(this)"
                                               class="select-all"><?php echo  __( 'Select All') ?></a>
                                        </span>
                        ...
                        <div id="post-body">
                            <div id="post-body-content">
                                ...
                                <div class="menu-settings">
                                    <h3><?php echo  __( 'Menu Settings') ?></h3>
                                    <dl class="auto-add-pages">
                                        <dt class="menu-style"><?php echo  __( 'Menu Style') ?></dt>
