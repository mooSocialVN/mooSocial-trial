...
;(function ($, window){
    ...
    Rate.prototype.build = function()
    {
        ...
        {
            this.icon_class = $(this.element).attr("data-icon-class");
        }
    ...
    Rate.prototype.addLayer = function(layer_name, visible_width, symbol, visible)
    {
        ...
        if($(layer).children().children().length > 0){
            $(layer).children().children().addClass(this.icon_class);
        }else{
            $(layer).children().addClass(this.icon_class);
        }
        $(layer).css({
            width: visible_width + "%",
    ...
    $.fn.rate.settings = {
        ...
        symbols: {
            ...
            moo_star:{
                base: '<div class="material-icons core-rating-icon core-rating-base">star_border</div>',
                hover: '<div class="material-icons core-rating-icon core-rating-hover">star</div>',
                selected: '<div class="material-icons core-rating-icon core-rating-selected">star</div>',
            }
        },
        selected_symbol_type: 'moo_star', // Must be a key from symbols
